...
🕐 *Last updated: 2025-11-13T13:29:03.684Z*
...
```4d
Function getMigrationRules($RemoteEntity : cs.ToolTemperatureZoneEntity) -> Collection
```
...
- [ToolTemperatureZone](../Tables/ToolTemperatureZone.md) - Entity class
