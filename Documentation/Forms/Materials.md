...
| **Form Method** | ✅ Yes |
| **Object Methods** | 19 |
| **Generated** | 🕐 2025-11-13T16:07:03.211Z |
...
|:-----|:-----|:-------:|:-------:|:---------:|:------------|:-------|
| Check Box | ☑️ checkbox | ✅ | ✅ | ❌ | Materials_IncludeArchived | [Check Box.4dm](https://github.com/synthotec/SynthoTec-4D/blob/main/Project/Sources/Forms/Materials/ObjectMethods/Check%20Box.4dm) |
| Radio Button | 🔘 radio | ✅ | ✅ | ❌ | Materials_NameSort | [Radio Button.4dm](https://github.com/synthotec/SynthoTec-4D/blob/main/Project/Sources/Forms/Materials/ObjectMethods/Radio%20Button.4dm) |
| Radio Button1 | 🔘 radio | ✅ | ✅ | ❌ | Materials_ColourSort | [Radio Button1.4dm](https://github.com/synthotec/SynthoTec-4D/blob/main/Project/Sources/Forms/Materials/ObjectMethods/Radio%20Button1.4dm) |
| Rectangle1 | 📄 text | ✅ | ✅ | ❌ | - | - |
| Button | 🔘 button | ✅ | ✅ | ❌ | - | [Button.4dm](https://github.com/synthotec/SynthoTec-4D/blob/main/Project/Sources/Forms/Materials/ObjectMethods/Button.4dm) |
| Text | 📄 text | ✅ | ✅ | ❌ | - | - |
...
| Text9 | 📄 text | ✅ | ✅ | ❌ | - | - |
| EditButton | 🔘 button | ✅ | ✅ | ❌ | - | [EditButton.4dm](https://github.com/synthotec/SynthoTec-4D/blob/main/Project/Sources/Forms/Materials/ObjectMethods/EditButton.4dm) |
| CancelButton | 🔘 button | ✅ | ✅ | ❌ | - | [CancelButton.4dm](https://github.com/synthotec/SynthoTec-4D/blob/main/Project/Sources/Forms/Materials/ObjectMethods/CancelButton.4dm) |
| SaveButton | 🔘 button | ✅ | ✅ | ❌ | - | [SaveButton.4dm](https://github.com/synthotec/SynthoTec-4D/blob/main/Project/Sources/Forms/Materials/ObjectMethods/SaveButton.4dm) |
| Button1 | 🔘 button | ✅ | ✅ | ❌ | - | [Button1.4dm](https://github.com/synthotec/SynthoTec-4D/blob/main/Project/Sources/Forms/Materials/ObjectMethods/Button1.4dm) |
...
| ArchiveButton* | 🔘 button | ✅ | ✅ | ❌ | - | [ArchiveButton%2A.4dm](https://github.com/synthotec/SynthoTec-4D/blob/main/Project/Sources/Forms/Materials/ObjectMethods/ArchiveButton%2A.4dm) |
...
| RemoveButtonC | 🔘 button | ✅ | ✅ | ❌ | - | [RemoveButtonC.4dm](https://github.com/synthotec/SynthoTec-4D/blob/main/Project/Sources/Forms/Materials/ObjectMethods/RemoveButtonC.4dm) |
| RemoveButtonB | 🔘 button | ✅ | ✅ | ❌ | - | [RemoveButtonB.4dm](https://github.com/synthotec/SynthoTec-4D/blob/main/Project/Sources/Forms/Materials/ObjectMethods/RemoveButtonB.4dm) |
| Text12 | 📄 text | ✅ | ✅ | ❌ | - | - |
