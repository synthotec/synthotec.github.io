...
Returns migration settings for WorksOrder with linking disabled and property formulas for new entities
...
- [WorksOrder](../Tables/WorksOrder.md) - ORDA DataClass class for WorksOrder table
