...
📊 **Overview:** 19 Fields | 3 Indexes | 9 Many-to-One Relations | 127 One-to-Many Relations
...
- **Generated:** 🕐 2025-11-12T23:10:09Z
...
| `SuppliersEntity` | [Suppliers](Suppliers.md) | `SupplierID_l` → `SupplierID_l` | - |
| `PackagingCatsEntity` | [PackagingCats](PackagingCats.md) | `PackagingCat` → `ID` | - |
...
*Generated at: 2025-11-12T23:10:09Z*
