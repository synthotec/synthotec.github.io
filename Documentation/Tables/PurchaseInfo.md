...
- **Field:** `OrderNo_l` - Kind: regular, Type: 7
- **Field:** `UniqueID_l` (Unique) - Kind: regular, Type: 7
- **Field:** `Invoiced` - Kind: regular, Type: 7
- **Field:** `SuppliesID_i` - Kind: regular, Type: 7
- **Field:** `Description_txt` - Kind: keywords, Type: 3
- **Field:** `Received` - Kind: regular, Type: 7
- **Field:** `DateRequested` - Kind: regular, Type: 7
- **Field:** `Description_txt` - Kind: regular, Type: 7
...
Links to table: [Supplies](Supplies.md)
...
Links to table: [NominalCodes](NominalCodes.md)
