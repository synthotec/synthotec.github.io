...
📊 **Overview:** 18 Fields | 3 Indexes | 3 Many-to-One Relations | 133 One-to-Many Relations
...
- **Generated:** 🕐 2025-11-12T23:10:20Z
...
|:------|:-----|:-----|:-------|
| `OrderNo_l` | - | regular | ✨ Yes |
| `SupplierID_l` | - | regular | - |
| `Archived_b` | - | regular | - |
...
|:--------------|:------------------|:---------------------|:------|
| `SuppliersEntity` | [Suppliers](Suppliers.md) | `SupplierID_l` → `SupplierID_l` | - |
| `SuppliersEntity` | [Suppliers](Suppliers.md) | `SupplierID_l` → `SupplierID_l` | - |
...
*Generated at: 2025-11-12T23:10:20Z*
