...
- **Field:** `MatID` - Kind: regular, Type: 7
- **Field:** `WorksOrder` - Kind: regular, Type: 7
- **Field:** `Machine` - Kind: regular, Type: 3
- **Field:** `PartName` - Kind: regular, Type: 3
- **Field:** `ID` (Unique) - Kind: regular, Type: 7
- **Field:** `MCDate` - Kind: regular, Type: 7
- **Field:** `ToolChange` - Kind: regular, Type: 3
- **Field:** `WheelID` - Kind: regular, Type: 3
- **Field:** `ToolID` - Kind: regular, Type: 3
