...
📊 **Overview:** 6 Fields | 2 Indexes | 3 Many-to-One Relations | 133 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:08:51Z
...
| `Advice_NoteEntity` | [Advice_Note](Advice_Note.md) | `Advice_Note_No` → `Advice_Note_No` | - |
| `CustomerEntity` | [Customer](Customer.md) | `Customer_Code` → `Customer_Code` | - |
...
*Generated at: 2025-11-12T23:08:51Z*
