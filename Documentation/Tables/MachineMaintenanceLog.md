...
📊 **Overview:** 7 Fields | 1 Indexes | 2 Many-to-One Relations | 134 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:12:39Z
...
|:--------------|:------------------|:---------------------|:------|
| `MachineMaintenanceActionsEntity` | [MachineMaintenanceActions](MachineMaintenanceActions.md) | `MachineMaintenanceActionID` → `ID` | - |
| `MachineMaintenanceActionsEntity` | [MachineMaintenanceActions](MachineMaintenanceActions.md) | `MachineMaintenanceActionID` → `ID` | - |
...
*Generated at: 2025-11-12T23:12:39Z*
