...
- **Field:** `Despatched` - Kind: regular, Type: 7
- **Field:** `OrderPickRequestID` - Kind: regular, Type: 7
- **Field:** `CofCID` - Kind: regular, Type: 7
- **Field:** `Verified` - Kind: regular, Type: 7
- **Field:** `UUID` (Unique) - Kind: regular, Type: 7
- **Field:** `ProductID` - Kind: regular, Type: 7
- **Field:** `Printed` - Kind: regular, Type: 7
- **Field:** `Completed` - Kind: regular, Type: 7
- **Field:** `LocationID` - Kind: regular, Type: 7
- **Field:** `NewSystem` - Kind: regular, Type: 7
...
Links to table: [Location](Location.md)
