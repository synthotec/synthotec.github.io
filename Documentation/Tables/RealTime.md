...
- **Field:** `Stoppage` - Kind: regular, Type: 3
- **Field:** `ID` (Unique) - Kind: regular, Type: 1
- **Field:** `Robot` - Kind: regular, Type: 3
- **Field:** `WorksOrder` - Kind: regular, Type: 3
- **Field:** `EndDate` - Kind: regular, Type: 3
- **Field:** `WorksOrder` - Kind: regular, Type: 1
- **Field:** `DownReason` - Kind: regular, Type: 7
...
*Generated at: 2025-11-12T23:11:20Z*
