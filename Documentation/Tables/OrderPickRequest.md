...
📊 **Overview:** 4 Fields | 3 Indexes | 2 Many-to-One Relations | 134 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:12:50Z
...
- [🔗 One-to-Many Relations](#one-to-many-relations) (134)
...
|:------|:-----|:-----|:-------|
| `CustomerOrderID` | - | regular | - |
| `PickRequestID` | - | regular | - |
| `ID` | - | regular | ✨ Yes |
...
|:--------------|:------------------|:---------------------|:------|
| `PickRequestEntity` | [PickRequest](PickRequest.md) | `PickRequestID` → `ID` | - |
| `Customer_OrderEntity` | [Customer_Order](Customer_Order.md) | `CustomerOrderID` → `Petes_No` | - |
...
*Generated at: 2025-11-12T23:12:50Z*
