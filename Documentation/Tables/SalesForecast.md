...
- **Field:** `fYear` - Kind: regular, Type: 3
- **Field:** `ProductID` - Kind: regular, Type: 3
- **Field:** `SnapDate` - Kind: regular, Type: 3
- **Field:** `Customer` - Kind: regular, Type: 3
- **Field:** `PartName` - Kind: regular, Type: 3
- **Field:** `SnapShot` - Kind: regular, Type: 3
- **Field:** `ID` (Unique) - Kind: regular, Type: 1
...
*Generated at: 2025-11-12T23:11:12Z*
