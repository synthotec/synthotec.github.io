...
- **Field:** `Material Name` - Kind: regular, Type: 7
- **Field:** `ID` (Unique) - Kind: regular, Type: 7
- **Field:** `Part No` - Kind: regular, Type: 7
- **Field:** `Price` - Kind: regular, Type: 7
- **Field:** `Product ID` - Kind: regular, Type: 7
- **Field:** `Tool No` - Kind: regular, Type: 7
- **Field:** `Customer Code` - Kind: regular, Type: 7
