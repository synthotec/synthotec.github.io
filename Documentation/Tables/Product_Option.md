...
📊 **Overview:** 29 Fields | 8 Indexes | 5 Many-to-One Relations | 131 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:08:55Z
...
- [🔗 One-to-Many Relations](#one-to-many-relations) (131)
...
|:------|:-----|:-----|:-------|
| `Material Name` | - | regular | - |
| `ID` | - | regular | ✨ Yes |
| `Part No` | - | regular | - |
| `Price` | - | regular | - |
| `Product ID` | - | regular | - |
| `Tool No` | - | regular | - |
| `Customer Code` | - | regular | - |
| `Material_ID` | - | regular | - |
...
| `ProductEntity` | [Product](Product.md) | `Product ID` → `Product_ID` | - |
| `MaterialEntity` | [Material](Material.md) | `Material_ID` → `Unique_ID` | - |
| `CustomerEntity` | [Customer](Customer.md) | `Customer Code` → `Customer_Code` | - |
| `ToolsEntity` | [Tools](Tools.md) | `Tool ID` → `Tool_ID` | - |
...
*Generated at: 2025-11-12T23:08:55Z*
