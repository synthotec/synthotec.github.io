...
📊 **Overview:** 8 Fields | 3 Indexes | 19 Many-to-One Relations | 117 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:12:43Z
...
- [📋 Fields](#fields) (8)
- [🔍 Indexes](#indexes) (3)
- [🔗 Many-to-One Relations](#many-to-one-relations) (19)
- [🔗 One-to-Many Relations](#one-to-many-relations) (117)
...
| `WorksOrderEntity` | [WorksOrder](WorksOrder.md) | `WorksOrder` → `Works_Order_No` | - |
| `WorksOrderEntity` | [WorksOrder](WorksOrder.md) | `WorksOrder` → `Works_Order_No` | - |
| `StaffEntity` | [Staff](Staff.md) | `StaffID` → `StaffID` | - |
| `StaffEntity` | [Staff](Staff.md) | `StaffID` → `StaffID` | - |
| `StaffEntity` | [Staff](Staff.md) | `StaffID` → `StaffID` | - |
| `FirstRealTimeEntity` | [RealTime](RealTime.md) | `FirstRealTimeID` → `ID` | - |
| `LastRealTimeEntity` | [RealTime](RealTime.md) | `LastRealTimeID` → `ID` | - |
| `WorksOrderEntity` | [WorksOrder](WorksOrder.md) | `WorksOrder` → `Works_Order_No` | - |
| `StaffEntity` | [Staff](Staff.md) | `StaffID` → `StaffID` | - |
| `StaffEntity` | [Staff](Staff.md) | `StaffID` → `StaffID` | - |
| `WorksOrderEntity` | [WorksOrder](WorksOrder.md) | `WorksOrder` → `Works_Order_No` | - |
...
*Generated at: 2025-11-12T23:12:43Z*
