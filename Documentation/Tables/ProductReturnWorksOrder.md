...
📊 **Overview:** 8 Fields | 3 Indexes | 3 Many-to-One Relations | 133 One-to-Many Relations
...
- **Generated:** 🕐 2025-11-12T23:10:38Z
...
|:------|:-----|:-----|:-------|
| `ReturnID_l` | - | regular | - |
| `WOReturnID_l` | - | regular | ✨ Yes |
| `Works_Order_No_l` | - | regular | - |
...
|:--------------|:------------------|:---------------------|:------|
| `WorksOrderEntity` | [WorksOrder](WorksOrder.md) | `Works_Order_No_l` → `Works_Order_No` | - |
| `ProductReturnEntity` | [ProductReturn](ProductReturn.md) | `ReturnID_l` → `ReturnID_l` | - |
| `WorksOrderEntity` | [WorksOrder](WorksOrder.md) | `Works_Order_No_l` → `Works_Order_No` | - |
...
*Generated at: 2025-11-12T23:10:38Z*
