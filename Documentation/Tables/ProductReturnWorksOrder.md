...
- **Field:** `ReturnID_l` - Kind: regular, Type: 7
- **Field:** `WOReturnID_l` (Unique) - Kind: regular, Type: 7
- **Field:** `Works_Order_No_l` - Kind: regular, Type: 7
...
Links to table: [ProductReturn](ProductReturn.md)
