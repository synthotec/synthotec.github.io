...
- **Field:** `UsageMatID3` - Kind: regular, Type: 7
- **Field:** `UsageMatID` - Kind: regular, Type: 7
- **Field:** `Current` - Kind: regular, Type: 7
- **Field:** `Archive` - Kind: regular, Type: 7
- **Field:** `MigrationID` - Kind: regular, Type: 7
- **Field:** `UsageMatID2` - Kind: regular, Type: 7
- **Field:** `MaterialName` - Kind: regular, Type: 7
- **Field:** `Unique_ID` (Unique) - Kind: regular, Type: 7
- **Field:** `Customers Name` - Kind: regular, Type: 7
