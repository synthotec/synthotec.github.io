...
📊 **Overview:** 26 Fields | 9 Indexes | 3 Many-to-One Relations | 133 One-to-Many Relations
...
- **Generated:** 🕐 2025-11-12T23:08:53Z
...
| `MigrationID` | - | regular | - |
| `UsageMatID2` | - | regular | - |
| `MaterialName` | - | regular | - |
| `Unique_ID` | - | regular | ✨ Yes |
| `Customers Name` | - | regular | - |
...
|:--------------|:------------------|:---------------------|:------|
| `UsageMat1Entity` | [Material](Material.md) | `UsageMatID` → `Unique_ID` | - |
| `UsageMat2Entity` | [Material](Material.md) | `UsageMatID2` → `Unique_ID` | - |
| `UsageMat3Entity` | [Material](Material.md) | `UsageMatID3` → `Unique_ID` | - |
...
*Generated at: 2025-11-12T23:08:53Z*
