...
📊 **Overview:** 8 Fields | 3 Indexes | 5 Many-to-One Relations | 131 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:12:36Z
...
| `PurchaseInfoEntity` | [PurchaseInfo](PurchaseInfo.md) | `PurchaseInfoID` → `UniqueID_l` | - |
| `RMCEntity` | [RMC](RMC.md) | `RMC` → `RMCNo_l` | - |
| `RMCEntity` | [RMC](RMC.md) | `RMC` → `RMCNo_l` | - |
| `RMCEntity` | [RMC](RMC.md) | `RMC` → `RMCNo_l` | - |
...
*Generated at: 2025-11-12T23:12:36Z*
