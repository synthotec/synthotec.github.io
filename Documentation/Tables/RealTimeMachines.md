...
📊 **Overview:** 32 Fields | 2 Indexes | 2 Many-to-One Relations | 134 One-to-Many Relations
...
- **Primary Key:** 🔑 `Machine`
- **Generated:** 🕐 2025-11-12T23:11:25Z
...
|:--------------|:------------------|:---------------------|:------|
| `DownReasonsEntity` | [DownReasons](DownReasons.md) | `DownReason` → `ID` | - |
| `DownReasonsEntity` | [DownReasons](DownReasons.md) | `DownReason` → `ID` | - |
