...
📊 **Overview:** 4 Fields | 2 Indexes | 2 Many-to-One Relations | 134 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:11:17Z
...
|:--------------|:------------------|:---------------------|:------|
| `CalibrationEquipmentEntity` | [CalibrationEquipment](CalibrationEquipment.md) | `EquipmentID` → `ID` | - |
| `CalibrationEquipmentENtity` | [CalibrationEquipment](CalibrationEquipment.md) | `EquipmentID` → `ID` | - |
...
*Generated at: 2025-11-12T23:11:17Z*
