...
📊 **Overview:** 11 Fields | 5 Indexes | 10 Many-to-One Relations | 126 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:12:52Z
...
| `StaffEntity` | [Staff](Staff.md) | `StaffID` → `StaffID` | - |
| `StaffEntity` | [Staff](Staff.md) | `StaffID` → `StaffID` | - |
| `PrinterEntity` | [Printer](Printer.md) | `PrinterID` → `ID` | - |
| `PalletEntity` | [Pallet](Pallet.md) | `RelatedUUID` → `UUID` | - |
| `StaffEntity` | [Staff](Staff.md) | `StaffID` → `StaffID` | - |
| `StaffEntity` | [Staff](Staff.md) | `StaffID` → `StaffID` | - |
| `StaffEntity` | [Staff](Staff.md) | `StaffID` → `StaffID` | - |
...
*Generated at: 2025-11-12T23:12:52Z*
