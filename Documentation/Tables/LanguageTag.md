...
- **Field:** `ID_l` (Unique) - Kind: regular, Type: 7
- **Field:** `Language_ID` - Kind: regular, Type: 7
- **Field:** `TagIdentifier_s` - Kind: regular, Type: 7

## Many-to-One Relations

### LanguageENtity

Links to table: [Language](Language.md)
