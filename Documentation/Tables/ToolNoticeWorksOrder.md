...
📊 **Overview:** 4 Fields | 4 Indexes | 10 Many-to-One Relations | 126 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:13:00Z
...
| `WorksOrderEntity` | [WorksOrder](WorksOrder.md) | `WorksOrder` → `Works_Order_No` | - |
| `WorksOrderEntity` | [WorksOrder](WorksOrder.md) | `WorksOrder` → `Works_Order_No` | - |
| `ToolNoticeEntity` | [ToolNotice](ToolNotice.md) | `ToolNoticeID` → `ToolID` | - |
| `WorksOrderEntity` | [WorksOrder](WorksOrder.md) | `WorksOrder` → `Works_Order_No` | - |
...
*Generated at: 2025-11-12T23:13:00Z*
