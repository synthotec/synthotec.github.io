...
📊 **Overview:** 12 Fields | 4 Indexes | 4 Many-to-One Relations | 132 One-to-Many Relations
...
- **Primary Key:** 🔑 `RMCNo_l`
- **Generated:** 🕐 2025-11-12T23:10:34Z
...
|:------|:-----|:-----|:-------|
| `MaterialID_l` | - | regular | - |
| `PurchaseInfoID` | - | regular | - |
| `RMCNo_l` | - | regular | ✨ Yes |
| `RMCDate_d` | - | regular | - |
...
| `MaterialEntity` | [Material](Material.md) | `MaterialID_l` → `Unique_ID` | - |
| `PurchaseInfoEntity` | [PurchaseInfo](PurchaseInfo.md) | `PurchaseInfoID` → `UniqueID_l` | - |
| `PurchaseInfoEntity` | [PurchaseInfo](PurchaseInfo.md) | `PurchaseInfoID` → `UniqueID_l` | - |
