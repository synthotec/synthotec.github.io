...
- **Field:** `MaterialID_l` - Kind: regular, Type: 7
- **Field:** `PurchaseInfoID` - Kind: regular, Type: 7
- **Field:** `RMCNo_l` (Unique) - Kind: regular, Type: 7
- **Field:** `RMCDate_d` - Kind: regular, Type: 7
