...
📊 **Overview:** 24 Fields | 4 Indexes | 6 Many-to-One Relations | 130 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:08:47Z
...
| `WorksOrderEntity` | [WorksOrder](WorksOrder.md) | `Works_Order_No_l` → `Works_Order_No` | - |
| `Stock_LocationEntity` | [Stock_Location](Stock_Location.md) | `To_Location_l` → `StockLocationID_l` | - |
| `ProductEntity` | [Product](Product.md) | `ProductID_l` → `Product_ID` | - |
| `ProductEntity` | [Product](Product.md) | `ProductID_l` → `Product_ID` | - |
...
*Generated at: 2025-11-12T23:08:47Z*
