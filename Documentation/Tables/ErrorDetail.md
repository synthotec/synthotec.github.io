...
📊 **Overview:** 7 Fields | 4 Indexes | 1 Many-to-One Relations | 135 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:12:57Z
...
|:--------------|:------------------|:---------------------|:------|
| `ErrorEntity` | [Error](Error.md) | `ErrorID` → `ID` | - |
...
*Generated at: 2025-11-12T23:12:57Z*
