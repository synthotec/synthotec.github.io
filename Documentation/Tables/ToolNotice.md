...
📊 **Overview:** 10 Fields | 2 Indexes | 18 Many-to-One Relations | 118 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:12:59Z
...
- [📋 Fields](#fields) (10)
- [🔍 Indexes](#indexes) (2)
- [🔗 Many-to-One Relations](#many-to-one-relations) (18)
- [🔗 One-to-Many Relations](#one-to-many-relations) (118)
...
| `ToolsEntity` | [Tools](Tools.md) | `ToolID` → `Tool_ID` | - |
| `StaffEntity` | [Staff](Staff.md) | `StaffID` → `StaffID` | - |
| `DeactivatedStaffEntity` | [Staff](Staff.md) | `DeactivatedStaffID` → `StaffID` | - |
...
*Generated at: 2025-11-12T23:12:59Z*
