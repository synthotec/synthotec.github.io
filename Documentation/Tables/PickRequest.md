...
📊 **Overview:** 8 Fields | 7 Indexes | 6 Many-to-One Relations | 130 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:12:49Z
...
|:------|:-----|:-----|:-------|
| `Customer` | - | regular | - |
| `PickedNotificationSent` | - | regular | - |
| `ReadyToPick` | - | regular | - |
| `Type` | - | regular | - |
| `Processed` | - | regular | - |
| `ID` | - | regular | ✨ Yes |
| `AdviceNoteID` | - | regular | - |
...
| `Advice_NoteEntity` | [Advice_Note](Advice_Note.md) | `AdviceNoteID` → `ID` | - |
| `CustomerEntity` | [Customer](Customer.md) | `Customer` → `Customer_Code` | - |
| `CustomerEntity` | [Customer](Customer.md) | `Customer` → `Customer_Code` | - |
| `CustomerEntity` | [Customer](Customer.md) | `Customer` → `Customer_Code` | - |
| `CustomerEntity` | [Customer](Customer.md) | `Customer` → `Customer_Code` | - |
