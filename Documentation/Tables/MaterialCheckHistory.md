...
📊 **Overview:** 11 Fields | 6 Indexes | 18 Many-to-One Relations | 118 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:10:46Z
...
| `WorksOrderEntity` | [WorksOrder](WorksOrder.md) | `WorksOrder` → `Works_Order_No` | - |
| `MaterialEntity` | [Material](Material.md) | `MaterialID` → `Unique_ID` | - |
| `RMCEntity1` | [RMC](RMC.md) | `RMC1` → `RMCNo_l` | - |
| `RMCEntity2` | [RMC](RMC.md) | `RMC2` → `RMCNo_l` | - |
| `RMCEntity3` | [RMC](RMC.md) | `RMC3` → `RMCNo_l` | - |
| `MaterialEntity` | [Material](Material.md) | `MaterialID` → `Unique_ID` | - |
| `WorksOrderEntity` | [WorksOrder](WorksOrder.md) | `WorksOrder` → `Works_Order_No` | - |
| `WorksOrderEntity` | [WorksOrder](WorksOrder.md) | `WorksOrder` → `Works_Order_No` | - |
| `MaterialEntity` | [Material](Material.md) | `MaterialID` → `Unique_ID` | - |
