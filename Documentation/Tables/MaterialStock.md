...
📊 **Overview:** 12 Fields | 7 Indexes | 11 Many-to-One Relations | 125 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:11:11Z
...
|:------|:-----|:-----|:-------|
| `LabelsPrinted` | - | regular | - |
| `LocationID` | - | regular | - |
| `ID` | - | regular | ✨ Yes |
| `PalletNumber` | - | regular | - |
| `SheetsPrinted` | - | regular | - |
| `RMC` | - | regular | - |
| `MaterialID` | - | regular | - |
...
| `LocationEntity` | [Location](Location.md) | `LocationID` → `ID` | - |
| `MaterialEntity` | [Material](Material.md) | `MaterialID` → `Unique_ID` | - |
| `RMCEntity` | [RMC](RMC.md) | `RMC` → `RMCNo_l` | - |
| `MaterialEntity` | [Material](Material.md) | `MaterialID` → `Unique_ID` | - |
| `RMCEntity` | [RMC](RMC.md) | `RMC` → `RMCNo_l` | - |
...
*Generated at: 2025-11-12T23:11:11Z*
