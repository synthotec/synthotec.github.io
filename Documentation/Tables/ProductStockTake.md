...
📊 **Overview:** 7 Fields | 1 Indexes | 12 Many-to-One Relations | 124 One-to-Many Relations
...
- **Primary Key:** 🔑 `ID`
- **Generated:** 🕐 2025-11-12T23:11:18Z
...
- [📋 Fields](#fields) (7)
- [🔍 Indexes](#indexes) (1)
- [🔗 Many-to-One Relations](#many-to-one-relations) (12)
- [🔗 One-to-Many Relations](#one-to-many-relations) (124)
...
| `ProductEntity` | [Product](Product.md) | `ProductID` → `Product_ID` | - |
| `WorksOrderEntity` | [WorksOrder](WorksOrder.md) | `WO` → `Works_Order_No` | - |
| `ProductEntity` | [Product](Product.md) | `ProductID` → `Product_ID` | - |
| `ProductEntity` | [Product](Product.md) | `ProductID` → `Product_ID` | - |
| `ProductEntity` | [Product](Product.md) | `ProductID` → `Product_ID` | - |
| `ProductEntity` | [Product](Product.md) | `ProductID` → `Product_ID` | - |
...
*Generated at: 2025-11-12T23:11:18Z*
