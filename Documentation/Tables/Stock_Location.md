...
- **Field:** `Is_Consignment_b` - Kind: regular, Type: 7
- **Field:** `DeafultPackingLocation_b` - Kind: regular, Type: 7
- **Field:** `DespatchLocation` - Kind: regular, Type: 7
- **Field:** `StockLocationID_l` (Unique) - Kind: regular, Type: 7
